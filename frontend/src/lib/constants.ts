...
export const FAQ_DATA: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Our rates start from ₹12/km for Sedan, ₹15/km for SUV (Ertiga), ₹20/km for Premium SUV (Innova Crysta), and ₹25/km for Tempo Traveller. Local packages start at ₹1,800 for 8 hours / 80 km.",
  },
  {
    question: "Do you provide outstation taxi services from Gwalior?",
    answer:
      "Yes, we provide outstation services to all major cities including Ujjain, Agra, Delhi, Jaipur, Orchha, Khajuraho, Jhansi, and more. Both round-trip options and customized itineraries are available.",
  },
  {
